...
const buttonStyle = tva({
  base: 'group/button rounded-full bg-primary-700 flex-row items-center justify-center data-[focus-visible=true]:web:outline-none data-[focus-visible=true]:web:ring-2 data-[disabled=true]:opacity-40 gap-2',
  variants: {
    action: {
      primary:
        'bg-primary-700 data-[hover=true]:bg-primary-800 data-[active=true]:bg-primary-800 border-primary-500 data-[hover=true]:border-primary-600 data-[active=true]:border-primary-500 data-[focus-visible=true]:web:ring-indicator-info',
      secondary:
